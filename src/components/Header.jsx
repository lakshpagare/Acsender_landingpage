...
const callsToAction = { name: "Call Now", href: "tel:+919511868630", icon: PhoneIcon }
    ...
    <header className="bg-white z-10">
      ...
      >
                ...
                <AnimatePresence>
                  {open && (
                    ...
                    >
                      ...
                      <div className=" divide-x divide-indigo-500 bg-indigo-600">
                        <Link
                          href={callsToAction.href}
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="invisible text-sm font-semibold leading-6 text-gray-900">
